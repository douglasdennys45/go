...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/clean_architecture.golang.UserService/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/clean_architecture.golang.UserService/CreateUser",
	}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "clean_architecture.golang.UserService",
