...
// Source: internal/domain/repositories/user-repo.go
...
import (
	...
	entities "github.com/douglasdennys45/go/internal/domain/entities"
...
func (m *MockUserRepo) Create(arg0 *entities.User) error {
	m.ctrl.T.Helper()
...
func (m *MockUserRepo) GetByID(id string) (*entities.User, error) {
	m.ctrl.T.Helper()
